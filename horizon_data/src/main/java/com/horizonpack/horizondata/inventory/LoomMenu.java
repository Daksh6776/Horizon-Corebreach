...
public class LoomMenu extends AbstractContainerMenu {
    ...
    public LoomMenu(int containerId, Inventory playerInventory) {
        // 3 slots: Fiber Input, Dye Input, Output
        this(containerId, playerInventory, new SimpleContainer(3), ContainerLevelAccess.NULL);
    }

    public LoomMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(DataRegistries.LOOM_MENU.get(), containerId);
