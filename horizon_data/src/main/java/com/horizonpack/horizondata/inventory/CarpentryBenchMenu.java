...
public class CarpentryBenchMenu extends AbstractContainerMenu {
    private final Container container;
    private final ContainerLevelAccess access;

    public CarpentryBenchMenu(int containerId, Inventory playerInventory) {
    ...
    public CarpentryBenchMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(DataRegistries.CARPENTRY_BENCH_MENU.get(), containerId);
