...
public class PotteryWheelMenu extends AbstractContainerMenu {
    ...
    public PotteryWheelMenu(int containerId, Inventory playerInventory) {
        // 2 slots: 1 Input (Clay), 1 Output (Pottery)
        this(containerId, playerInventory, new SimpleContainer(2), ContainerLevelAccess.NULL);
    }

    public PotteryWheelMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(DataRegistries.POTTERY_WHEEL_MENU.get(), containerId);
