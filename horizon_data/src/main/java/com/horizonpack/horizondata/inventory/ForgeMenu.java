...
public class ForgeMenu extends AbstractContainerMenu {
    ...
    // Server-side constructor (linked to BlockEntity)
    public ForgeMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(DataRegistries.FORGE_MENU.get(), containerId);
        ...
        this.addSlot(new Slot(container, 2, 116, 35) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return false; // Prevent placing items in output slot
            }
        });
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (index != 1 && index != 0) { // Player inventory/hotbar
                if (!this.moveItemStackTo(itemstack1, 0, 2, false)) return ItemStack.EMPTY; // Move to Input/Fuel
            } else { // Input or Fuel
