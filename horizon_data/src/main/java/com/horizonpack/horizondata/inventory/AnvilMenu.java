...
public class AnvilMenu extends AbstractContainerMenu {
    ...
    public AnvilMenu(int containerId, Inventory playerInventory, Container container, ContainerLevelAccess access) {
        super(DataRegistries.ANVIL_MENU.get(), containerId);
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index == 1) { // Output slot
                ...
                if (!this.moveItemStackTo(itemstack1, 0, 1, false)) return ItemStack.EMPTY; // Move to Input
            } else { // Input slot
